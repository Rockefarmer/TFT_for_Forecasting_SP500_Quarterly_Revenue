...
Status: initial public scaffold — code and docs evolving.
...
Primary metric: MAPE (%); secondary: MAE, RMSE, MdAPE, and accuracy 
=100−MAPE.

Example result table (placeholder):

Model	MAPE ↓	Accuracy ↑	Notes
TFT	9.31	90.69	h=1, panel model
SARIMA	23.01	76.99	best per-ticker config
ARIMA	25.26	74.74	best per-ticker config
LSTM	28.75	71.25	per-ticker

Replace with your run outputs from results/.
